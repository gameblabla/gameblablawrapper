...
{
	Load_Image(1,"data/background.cel");
	Load_Image(2,"data/back.cel");
	Load_Image(3,"data/bar_gauche.cel");
		Copy_Image(3, 14);
	Load_Image(4,"data/bar_droite.cel");
		Copy_Image(4, 15);
	Load_Image(5,"data/character.anim");
	Load_Image(6,"data/hammer_spr.anim");
		Copy_Image(6, 16);
		Copy_Image(6, 17);
		Copy_Image(6, 18);
	Load_Image(7,"data/cloud.cel");
		Copy_Image(7, 19);
	Load_Image(8,"data/gameover.cel");
	Load_Image(9,"data/try.cel");
	Load_Image(10,"data/score.anim");
		Copy_Image(10, 20);
		Copy_Image(10, 21);
		Copy_Image(10, 22);
	Load_Image(11,"data/helice.anim");
	Load_Image(12,"data/result.cel");
...
{
	Init_sound();
	Load_SFX(1, "gfx/smack.aif");
	Load_SFX(2, "gfx/switch.aif");
}
